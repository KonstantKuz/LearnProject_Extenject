...
//
//     private Dictionary<string, Pool> poolDictionary = null;
//
//    
...
//         {
//             Debug.LogError($"There is no pools with name {name}");
//         }
...
//         {
//             Debug.LogError($"There is no pools with tag {pooledObject.poolTag}");
//         }
